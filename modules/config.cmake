...
set_target_properties(  ${OFX_LOCAL_ADDONS_ACTIVE}
        PROPERTIES
        LIBRARY_OUTPUT_DIRECTORY    ${OF_CMAKE_LIBS}
        ARCHIVE_OUTPUT_DIRECTORY    ${OF_CMAKE_LIBS}
        )

set_target_properties( ${OFX_ADDONS_ACTIVE} PROPERTIES COMPILE_FLAGS "-std=c++17" )
set_target_properties( ${OFX_LOCAL_ADDONS_ACTIVE} PROPERTIES COMPILE_FLAGS "-std=c++17" )
